...
$c_Lcore$.prototype = new $h_O();
$c_Lcore$.prototype.constructor = $c_Lcore$;
/** @constructor */
function $h_Lcore$() {
  /*<skip>*/
}
$h_Lcore$.prototype = $c_Lcore$.prototype;
$c_Lcore$.prototype.init___ = (function() {
  return this
});
$c_Lcore$.prototype.main__V = (function() {
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert("Hi from Scala-js-dom")
});
$c_Lcore$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lcore$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lcore$ = new $TypeData().initClass({
  Lcore$: 0
}, false, "core$", {
  Lcore$: 1,
  O: 1,
...
$c_Lcore$.prototype.$classData = $d_Lcore$;
var $n_Lcore$ = (void 0);
function $m_Lcore$() {
  if ((!$n_Lcore$)) {
    $n_Lcore$ = new $c_Lcore$().init___()
  };
  return $n_Lcore$
}
$e.core = $m_Lcore$;
...
//# sourceMappingURL=scala-js-trial-fastopt.js.map
